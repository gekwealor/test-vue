<script>
    ...
    methods: {
        fetchData: function () {
            this.loading = true
            fetch(`https://api.github.com/repos/gekwealor/${this.$route.params.id}`, {
            headers: {
            ...
            fetch(`https://api.github.com/repos/gekwealor/${this.$route.params.id}/branches`, {
                headers: {
                    Accept: "application/json"
                },
            })
            ...
            fetch(`https://api.github.com/repos/gekwealor/${this.$route.params.id}/deployments`, {
                headers: {
                    Accept: "application/json"
                },
            })
...
<template>
    <div id="repodetails">
        ...
        <div v-else class="repodetails-card">
            ...
            <p v-else>Live site: <a :href="`https://gekwealor.github.io/${details.name}`">gekwealor.github.io/{{ details.name }}</a></p>
